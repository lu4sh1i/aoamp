...
function sf_register_settings() {
	...
	add_settings_field('sf_youtube', "Youtube URL-Null24.Net", 'sf_youtube_str', 'sf', 'sf_appearance', array('column' => 1, 'subsection' => 'social'));
	...
	add_settings_field('sf_search_bg', "Search field background fade-Null24.Net", 'sf_search_bg_str', 'sf', 'sf_appearance', array('subsection' => 'extra'));
	...
	add_settings_field('sf_padding', "Padding of menu item-Null24.Net", 'sf_padding_str', 'sf', 'sf_menu_items', array('chapter' => 'Customizing items'));
...
function sf_tab_logo_str() {
    $options = sf_get_options();
    echo '<h6>Logo or user profile photo.-Null24.Net</h6>';
	echo "
...
function sf_social_color_str() {
	...
	//echo '<h6>Applies to icons that don\'t have brand color e.g. mail icon.-Null24.Net</h6>';
