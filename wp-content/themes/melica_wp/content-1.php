...
<div class="meta">
	<div class="category text-left"><?php echo get_the_category_list( ', ' ); ?></div>
	<h1 class="text-left"><a href="<?php the_permalink() ?>" title="<?php the_title_attribute() ?>"><?php the_title() ?></a></h1>
	<div class="subline text-left">
